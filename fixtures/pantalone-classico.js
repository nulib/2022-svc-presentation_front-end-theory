export const pantaloneClassico = {
  ...
  metadata: [
    ...
    },
    {
      ...
      value: {
        none: ["1 mask : grey leather, elastic, fiber"],
      },
    },
    {
      label: {
          ...
          items: [
            {
              ...
              motivation: "painting",
              target:
                "https://acw5dcf49d.execute-api.us-east-1.amazonaws.com/dev/items/iiif-image-manifest-1/canvas/0",
              body: {
          ...
          items: [
            {
              ...
              motivation: "painting",
              target:
                "https://acw5dcf49d.execute-api.us-east-1.amazonaws.com/dev/items/iiif-image-manifest-1/canvas/1",
              body: {
          ...
          items: [
            {
              ...
              motivation: "painting",
              target:
                "https://acw5dcf49d.execute-api.us-east-1.amazonaws.com/dev/items/iiif-image-manifest-1/canvas/2",
              body: {
